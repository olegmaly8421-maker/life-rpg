...
export function Btn({ children, variant = 'primary', style, ...props }) {
  ...
  return (
    <button style={{
      ...
      cursor: 'pointer', transition: 'opacity 0.2s', ...v[variant], ...style,
...
export function Input({ style, ...props }) {
  return <input style={{
    ...
    padding: '8px 11px', color: '#E2E8F0', fontSize: 13, outline: 'none', width: '100%', ...style,
  }} {...props} />
}

export function Label({ children }) {
  return <div style={{
    color: '#6B7280', fontSize: 11, fontWeight: 600, letterSpacing: 2,
